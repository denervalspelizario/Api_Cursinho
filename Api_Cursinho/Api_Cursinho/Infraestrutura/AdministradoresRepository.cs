...
namespace Api_Cursinho.Infraestrutura
{
    public class AdministradoresRepository
    {
         ...
         // Pegando o contexto do banco de dados 
         private readonly ConnectionContext _context = new ConnectionContext();

        // Metodo de adição de Adm
        public void Add(Administradores dadosAdm)
        {
            _context.administradores.Add(dadosAdm);
        ...
        // Método que lista todos os adms
